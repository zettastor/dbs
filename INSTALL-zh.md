...
有关操作系统支持列表、安装要求请参考 [安装操作系统](operatingsystem) 或者联系对应的工程师获取进一步的信息。
...
3. 部署完成之后，可通过浏览器访问 DBS Web 界面，访问地址为 `http://192.168.1.10:8080` 其中 `192.168.1.10` 为修改配置第13步中配置的“Web 界面的 IP 地址”。有关 DBS 的操作与使用，请参考 [用户手册](manual)。
